...
abstract class AppLocalizations {
  ...
  /// No description provided for @appointmentsHeadline.
  ///
  /// In en, this message translates to:
  /// **'Manage your appointments'**
  String get appointmentsHeadline;

  /// No description provided for @marketplaceHeadline.
  ///
  /// In en, this message translates to:
  /// **'Browse available products'**
  String get marketplaceHeadline;

  /// No description provided for @servicesHeadline.
  ///
  /// In en, this message translates to:
  /// **'Discover services'**
